<?php
/**
 * *copied from parent template for reference
...
// define function first to eliminate potential order of operation issues
...
// DO NOT END WITH PHP TAG - could cause rest of site to break